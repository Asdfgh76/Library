...
<div class="col-md-10">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('home')}}">Библиотека</a></li>
          <li class="breadcrumb-item" aria-current="page">Забронированные книги</li>
        </ol>
    </nav>
                    ...
                    @foreach($bookedBooks as $book)
                        <tr>
                            ...
                            <td>
                                ...
                                <p class="card-subtitle text-muted">{{$book->booked->end_date}}</p>
